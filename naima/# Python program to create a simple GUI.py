...
if __name__ == "__main__":
	...
	button2 = Button(gui, text=' 4 ', fg='black', bg='blue',
					command=lambda: press(2), height=1, width=7)
	button2.grid(row=2, column=1)

	button3 = Button(gui, text=' 7 ', fg='black', bg='blue',
					command=lambda: press(3), height=1, width=7)
	button3.grid(row=2, column=2)

	button4 = Button(gui, text=' 2 ', fg='black', bg='blue',
	...
	button6 = Button(gui, text=' 8 ', fg='black', bg='blue',
					command=lambda: press(6), height=1, width=7)
	button6.grid(row=3, column=2)

	button7 = Button(gui, text=' 3 ', fg='black', bg='blue',
					command=lambda: press(7), height=1, width=7)
	button7.grid(row=4, column=0)

	button8 = Button(gui, text=' 6 ', fg='black', bg='blue',
	...
	Decimal = Button(gui, text='Coss', fg='black', bg='blue',
					 command=lambda: press('Coss'), height=1, width=7)
	Decimal.grid(row=6, column=1)

	Decimal = Button(gui, text='Sign', fg='black', bg='blue',
					 command=lambda: press('Sin'), height=1, width=7)
	Decimal.grid(row=6, column=2)

	Decimal = Button(gui, text='Tan', fg='black', bg='blue',
